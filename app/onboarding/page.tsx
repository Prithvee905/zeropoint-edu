...
export default function Onboarding() {
  ...
  if (step === 1) return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "65vh", textAlign: "center", gap: "24px", padding: "0 24px" }}>
      <div className="spinner" style={{ width: "40px", height: "40px", borderTopColor: "var(--purple)" }} />
      <div className="fade-up">
        <h2 style={{ fontSize: "clamp(20px, 4vw, 26px)", fontWeight: "900", marginBottom: "8px" }}>Building your future...</h2>
        <p style={{ color: "var(--text-3)", fontSize: "14px", maxWidth: "320px", margin: "0 auto", lineHeight: "1.6" }}>
  ...
  return (
    <div className="fade-up" style={{ maxWidth: "560px", margin: "0 auto", paddingBottom: "100px" }}>
      ...
      <div style={{ marginBottom: "40px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: "clamp(14px, 2vw, 15px)", color: "var(--text-3)", lineHeight: "1.6", maxWidth: "380px", margin: "0 auto" }}>Explain your mission. ZEROPOINT will builder the engine to get you there.</p>
      </div>

      {/* Form */}
      <div className="card onboarding-form-card" style={{ padding: "clamp(24px, 5vw, 40px)", display: "flex", flexDirection: "column", gap: "28px", position: "relative", background: "rgba(var(--invert-rgb),0.01)" }}>
        
        {/* Step Indicator */}
        <div style={{ 
            position: "absolute", top: "-1px", left: "50%", transform: "translateX(-50%)", 
            background: "var(--purple)", color: "var(--text-1)", padding: "6px 16px", borderRadius: "0 0 10px 10px", 
            fontSize: "10px", fontWeight: "900", textTransform: "uppercase", letterSpacing: "0.15em" 
        }}>Plan Configuration</div>

        <div className="form-section">
          <label style={{ display: "block", fontSize: "11px", fontWeight: "900", color: "var(--text-3)", marginBottom: "10px", textTransform: "uppercase" }}>Primary Subject *</label>
        ...
        <div className="form-section">
          <label style={{ display: "block", fontSize: "11px", fontWeight: "900", color: "var(--text-3)", marginBottom: "10px", textTransform: "uppercase" }}>Learning Mission *</label>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "16px" }}>
          <div>
            <label style={{ display: "block", fontSize: "11px", fontWeight: "900", color: "var(--text-3)", marginBottom: "10px", textTransform: "uppercase" }}>Deadline</label>
          ...
          <div>
            <label style={{ display: "block", fontSize: "11px", fontWeight: "900", color: "var(--text-3)", marginBottom: "10px", textTransform: "uppercase" }}>Daily Intensity (Hrs) *</label>
        ...
        <div style={{ background: "rgba(124,58,237,0.03)", padding: "24px", borderRadius: "16px", border: "1px solid rgba(124,58,237,0.1)" }}>
          <label style={{ display: "block", fontSize: "11px", fontWeight: "900", color: "var(--text-2)", marginBottom: "12px", textTransform: "uppercase" }}>Boost with Syllabus PDF <span style={{ color: "var(--text-4)" }}>(Recommended)</span></label>
          <label style={{
            ...
            borderRadius: "14px", cursor: "pointer", fontSize: "13px", color: file ? "var(--purple-light)" : "var(--text-3)",
        ...
        <div style={{ paddingTop: "12px" }}>
          ...
          <p style={{ textAlign: "center", fontSize: "11px", color: "var(--text-4)", marginTop: "18px", lineHeight: "1.5" }}>Zeropoint handles your data with privacy priority.</p>
        </div>
